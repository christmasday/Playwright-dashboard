...
export const AiByokSettings: React.FC = () => {
      ...
      <div className="bg-[#1a1a22] border border-[#20202a] rounded-2xl p-6 shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-600/20">
              <i className="fas fa-wand-magic-sparkles text-xl"></i>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-[#f4f4f7] flex items-center gap-3">
                <span>AI Diagnostics & BYOK Configuration</span>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {(availableProviders.length > 0
                ? availableProviders
                : [
                    { id: 'gemini', name: 'Google Gemini', description: 'Ultra-fast multimodal reasoning & high token efficiency', icon: 'fa-wand-magic-sparkles' },
                    { id: 'openai', name: 'OpenAI', description: 'Flagship GPT-4o and reasoning models', icon: 'fa-robot' },
                    { id: 'anthropic', name: 'Anthropic Claude', description: 'Exceptional coding precision & extended thinking', icon: 'fa-brain' },
                    { id: 'groq', name: 'Groq Cloud', description: 'Lightning-fast LPU inference (500+ tokens/sec)', icon: 'fa-bolt' },
                    { id: 'deepseek', name: 'DeepSeek API', description: 'State-of-the-art coding and mathematical reasoning', icon: 'fa-microchip' },
                    { id: 'mistral', name: 'Mistral AI', description: 'Optimized developer models including Codestral', icon: 'fa-wind' },
                    { id: 'openrouter', name: 'OpenRouter', description: 'Universal gateway to every open & closed model', icon: 'fa-network-wired' },
                    { id: 'ollama', name: 'Local Ollama / Custom Endpoint', description: '100% on-premise, zero-data-leakage local LLMs', icon: 'fa-server' },
                    { id: 'heuristics', name: 'Built-in Offline Heuristics', description: 'Deterministic Playwright rule engine (No API key needed)', icon: 'fa-code' },
                  ]
              ).map((prov) => {
